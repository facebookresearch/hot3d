...
box2d_hands_resource = "aria_sample_recording/box2d_hands.csv"

try:
    from libfb.py import parutil

    box2d_hands_filepath = parutil.get_file_path(
        "test_data/" + box2d_hands_resource, pkg=__package__
    )
except ImportError:
    from pathlib import Path

    THIS_DIR = Path(__file__)
    box2d_hands_filepath = str(THIS_DIR.parent / box2d_hands_resource)
