...
# Load the list of sequences listed from the cdn file
...
def load_data_groups_from_cdn(cdn_file: str) -> Dict[str, List[str]]:
    ...
    # Only add "recording" and "mps" data if they are defined as different than None
    if main_data["recording"] != "None":
        data_groups["main_vrs"] = main_data["recording"]
    if main_data["mps"] != "None":
        # next add mps data groups which are predefined
